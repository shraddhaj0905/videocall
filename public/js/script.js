...
// Start call (automatically pick another user)
...
socket.on("incoming-call", (data) => {
    remoteUsername = data.from; // caller's name
...
socket.on("offer", async (data) => {
    remoteUsername = data.from; // set caller name
    await startCall(true);      // answerer
